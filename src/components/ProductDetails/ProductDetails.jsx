...
const ProductDetails = () => {
    ...
    return (
        ...
        <Typography color="text.primary">Info</Typography>
            ...
            {oneProduct ? <Box display={"flex"} flexDirection={"column"} alignItems={"center"} paddingTop={"50px"} textAlign={"center"} ><Paper style={{width: "40%"}} elevation={3}><img src={oneProduct.image} width="100%" alt='product' /></Paper>
            <Paper>
